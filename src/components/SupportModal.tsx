...
export default function SupportModal() {
  ...
  return (
    <div className="supportModal">
        <button className="fixed z-50 px-8 gap-x-2.5 top-[91.21%] bottom-[3.9%] right-[3.05%] bg-[#9DA09F] hover:bg-[#289D8C] text-gray-800 font-bold inline-flex items-center" type="button" onClick={onClick}>
 ...
 <div className="chat-popup" id="myForm" hidden={hideModal}>
  <form className="fixed z-50 gap-x-2.5 w-[25%] top-[40%] bottom-[3.9%] right-[3.05%] flex-col bg-[#F5F5F5]">
    <div className='flex flex-row h-[15%] items-center bg-[#9DA09F] px-8'>
    ...
    <div className="bg=[#F5F5F5] p-8">
        ...
        <button type="submit" className="text-start py-2 text-[#667080]">Chat with us</button>
