...
export default function SupportModal() {
        ...
        <div className="chat-popup" id="myForm" hidden={hideModal}>
            <form className="fixed z-50 gap-x-2.5 w-[25%] top-[40%] bottom-[3.9%] right-[3.05%] flex-col bg-[#F5F5F5] rounded-md">
                <div className='flex flex-row h-[15%] items-center bg-[#9DA09F] px-8 rounded-t-md'>
                    <h1 className="flex-auto font-semibold text-center text-white">How can we help?</h1>
  ...
  const Message = () => {
    return ( 
        <div className="chat-popup" id="myForm" hidden={hideModal}>
            <form className="fixed z-50 gap-x-2.5 w-[25%] top-[40%] bottom-[3.9%] right-[3.05%] flex-col bg-[#F5F5F5] rounded-md">
                <div className='flex flex-row h-[15%] items-center bg-[#9DA09F] px-8 rounded-t-md'>
                    <button className="flex-initial" type="button" onClick={()=> {setMenu("Default")} }>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" className="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" />
                        </svg>
                    </button>
                    <h1 className="flex-auto font-semibold text-center text-white">Leave us a message</h1>
                </div>

                <div className="bg=[#F5F5F5] p-8">
                    <h1 className="font-semibold py-2 underline">Suggestions</h1>
                    <div className='flex flex-col justify-start'>
                    <button type="submit" className="font-semibold text-start py-2">1. Leave a message</button>
                    <button type="submit" className="font-semibold text-start py-2">2. Send us a text</button>
                    </div>
        ...
        <div className="chat-popup" id="myForm" hidden={hideModal}>
            <form className="fixed z-50 gap-x-2.5 w-[25%] top-[40%] bottom-[3.9%] right-[3.05%] flex-col bg-[#F5F5F5] rounded-md">
                <div className='flex flex-row h-[15%] items-center bg-[#9DA09F] px-8 rounded-t-md'>
                    ...
                    <h1 className="flex-auto font-semibold text-center text-white">Send us a text</h1>
                </div>
        ...
        <div className="chat-popup" id="myForm" hidden={hideModal}>
            <form className="fixed z-50 gap-x-2.5 w-[25%] top-[40%] bottom-[3.9%] right-[3.05%] flex-col bg-[#F5F5F5] rounded-md">
                <div className='flex flex-row h-[15%] items-center bg-[#9DA09F] px-8 rounded-t-md'>
                    ...
                    <h1 className="flex-auto font-semibold text-center text-white">Chat with us</h1>
                </div>
  ...
  return (
        <div className="supportModal">
            <button className="fixed z-50 px-8 gap-x-2.5 top-[91.21%] bottom-[3.9%] right-[3.05%] bg-[#9DA09F] hover:bg-[#289D8C] text-gray-800 font-bold inline-flex items-center rounded-md" type="button" onClick={onClick}>
